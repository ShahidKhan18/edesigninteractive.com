(self.webpackChunkcpg_marketing_services =
  self.webpackChunkcpg_marketing_services || []).push([
  [773],
  {
    56024: function (t, e, i) {
                    ...
                    .done(function (e) {
                      try {
                        (e = JSON.parse(e)).status
                          ? (new w(t.form, null, e.success).showSuccess(),
                            new w(t.form, null, null).clearFields(),
                            o()(".user-typing").length &&
            ...
            p(t, [
              ...
              },
              {
                ...
                value: function () {
                  var t = this;
                  this.form
                    .find(".form-success-title")
                    .html(this.success.title),
                    this.form
                      .find(".form-success-txt")
                      .html(this.success.message),
      ...
      (i.p = window._root),
        a.ZP.registerPlugin(h.L),
        a.ZP.defaults({ ease: "power2.inOut", duration: 0.5 });
      var S = function (t) {
          "show" === t
            ? o()("html").addClass("show-contact-form")
            : o()("html").removeClass("show-contact-form");
        },
        y = function () {
          o()(".trigger-form-btn").on("click", function () {
            ...
            o()(".scroll-to-section-btn").on("click", function (t) {
              return (
                (e = o()(
                  '[data-section-target-id="'.concat(
                    o()(t.currentTarget).attr("data-section-target"),
                    '"]'
                  )
                )[0]),
                void ((0, c.tq)()
                  ? a.ZP.to(window, { duration: 1, scrollTo: { y: e } })
                  : f.scrollTo(e))
              );
              var e;
            }),
            o()(".ajax-form").on("submit", function (t) {
              ...
              t.preventDefault(),
                e.find(".form-error").removeClass("form-error"),
                e.hasClass("form-loading") ||
                  e.hasClass("form-success") ||
                  (e.addClass("form-loading"), new m(e, t));
            }),
            o()("form").on(
      ...
      (function () {
          ...
          o()("#contact-form").length &&
            ...
            (t = function () {
              if (o()(window).width() >= 720) {
                ...
                a.ZP.set(i, { clearProps: !0 }),
                  a.ZP.set(i, { width: e.width() });
              }
            })(),
        ...
        (function () {
          if (o()(".g-recaptcha").length) {
            ...
            (t.type = "text/javascript"),
              (t.async = !0),
              (t.defer = !0),
              (t.src = o()("#recaptchaScript").data("src")),
              o()("#recaptchaScript").remove(),
              o()("body").append(t);
          }
        })(),
        (f = !1),
        (0, c.tq)()
          ? o()(".scroll-to-next-btn")
              ...
              .on("click.gsapSmoothScroll", function (t) {
                a.ZP.to(document.body, {
                  duration: 1,
                  scrollTo: o()(t.currentTarget).parents("section").next()[0],
                });
              })
          : ((f = new r.ZP({
            ...
            document.addEventListener("keydown", function (t) {
              ("PageUp" !== t.key && "PageDown" !== t.key && " " !== t.key) ||
                (t.preventDefault(), t.stopPropagation());
            })),
        new s.Z(
          (0, c.Ds)(function () {
            o()(window).trigger("resizeObserverTrigger"),
              f && !(0, c.tq)() && f.update();
          }, 250)
        ...
        (0, l.S)(),
        (0, c.tq)() ||
          a.ZP.set(o()(".section-intro-title-container").find(".height-el"), {
            paddingTop: "".concat((innerHeight / innerWidth) * 100, "%"),
          });
    },
    64528: function (t, e, i) {
      ...
      var c = [],
        l = function () {
          (c[0] = new (s())({
            breakpoints: [{ width: 1024, src: "data-src-mobile" }],
            loadInvisible: !0,
            offset: 300,
          })),
            o()(".force-load-img").length &&
              c[0].load(o()(".force-load-img"), !0);
      ...
      var p = (function () {
        function t() {
          !(function (t, e) {
            ...
            o()(".splitByChars").length &&
              this.splitText(o()(".splitByChars"), "chars"),
            o()(".splitByWords").length &&
              this.splitText(o()(".splitByWords"), "words"),
            o()(".splitByLines").length &&
              this.splitText(o()(".splitByLines"), "lines"),
            o()(".splitByLinesChars").length &&
              this.splitText(o()(".splitByLinesChars"), "linesChars"),
            o()(".splitByAll").length &&
              this.splitText(o()(".splitByAll"), "all"),
            o()(".linesWordsLines").length &&
              this.splitText(o()(".linesWordsLines"), "linesWordsLines"),
            o()(".linesWordsLinesHover").length &&
              this.splitText(
                o()(".linesWordsLinesHover"),
                "linesWordsLinesHover"
              ),
            o()(".splitByWordsChars").length &&
              this.splitText(o()(".splitByWordsChars"), "wordsChars");
        }
        var e, i, n;
        return (
          (e = t),
                ...
                "lines" == e
                  ...
                  ? t.each(function (e, i) {
                      ...
                      new u.C(t[e], {
                        ...
                        new RegExp("\\b".concat(t.textContent, "\\b")).test(
                          n
                        ) && o()(t).addClass("strong-style");
                      });
                    })
                ...
                function (t, e, i) {
                  ...
                  function f(t, e, i) {
                    var o,
                      ...
                      h = A;
                    if (
                      a(d(t, e + 1), d(t, e), d(t, i)) &&
                      c(d(t, e - 1), d(t, e), d(t, i))
                    )
                      return !1;
                    r = u(d(t, e), d(t, i));
                  ...
                  e.exports = {
                    ...
                    quickDecomp: function t(e, i, n, o, r, l, f) {
                      ...
                      if (++f > l)
                        return (
                          console.warn(
                            "quickDecomp: max level (" + l + ") reached."
                          ),
                          i
                        );
                      for (var L = 0; L < e.length; ++L)
                        if (p(G, L)) {
                          ...
                          if (A === (T + 1) % e.length)
                            (y[0] = (S[0] + w[0]) / 2),
                              ...
                              T > L
                                ? (g(k, G, L, T + 1),
                                  k.push(y),
                                  x.push(y),
                                  0 !== A && g(x, G, A, G.length),
                                  g(x, G, 0, L + 1))
                                : (0 !== L && g(k, G, L, G.length),
                                  g(k, G, 0, T + 1),
                                  k.push(y),
                                  x.push(y),
                                  g(x, G, A, L + 1));
                            ...
                            V > L
                              ? (g(k, G, L, V + 1),
                                0 !== V && g(x, G, V, O.length),
                                g(x, G, 0, L + 1))
                              : (0 !== L && g(k, G, L, O.length),
                                g(k, G, 0, V + 1),
                                g(x, G, V, L + 1));
                          }
                          return (
                            k.length < x.length
                              ? (t(k, i, n, o, r, l, f), t(x, i, n, o, r, l, f))
                              : (t(x, i, n, o, r, l, f),
                                t(k, i, n, o, r, l, f)),
                            i
                          );
                    ...
                    isSimple: function (t) {
                      ...
                      for (e = 0; e < i.length - 1; e++)
                        for (var n = 0; e - 1 > n; n++)
                          if (o(i[e], i[e + 1], i[n], i[n + 1])) return !1;
                      for (e = 1; e < i.length - 2; e++)
                        if (o(i[0], i[i.length - 1], i[e], i[e + 1])) return !1;
                      return !0;
                    },
                    removeCollinearPoints: function (t, e) {
                      for (
                        ...
                        l(d(t, n - 1), d(t, n), d(t, n + 1), e) &&
                          (t.splice(n % t.length, 1), i++);
                      return i;
                    },
                    removeDuplicatePoints: function (t, e) {
                      for (var i = t.length - 1; i >= 1; --i)
                        for (var n = t[i], o = i - 1; o >= 0; --o)
                          b(n, t[o], e) && t.splice(i, 1);
                    },
                    makeCCW: function (t) {
                      for (var e = 0, i = t, n = 1; n < t.length; ++n)
                        (i[n][1] < i[e][1] ||
                          (i[n][1] === i[e][1] && i[n][0] > i[e][0])) &&
                          (e = n);
                      return (
      ...
      var y = function (t) {
        ...
        b = (function () {
          function t() {
            f(this, t),
              ...
              (this.images = [
                {
                  src: _root + "images/intro/triangle.svg",
                  name: "triangle",
                  scaleVal: 0,
                  degrees: 0,
                },
                {
                  src: _root + "images/intro/bottle.svg",
                  name: "bottle",
                  scaleVal: 0,
                  degrees: -45,
                },
                {
                  src: _root + "images/intro/candy.svg",
                  name: "candy",
                  scaleVal: 0,
                  degrees: 0,
                },
                {
                  src: _root + "images/intro/candy-2.svg",
                  name: "candy-2",
                  scaleVal: 0,
                  degrees: 0,
                },
                {
                  src: _root + "images/intro/star.svg",
                  name: "star",
                  scaleVal: 0,
                  degrees: 0,
                },
                {
                  src: _root + "images/intro/logo.svg",
                  name: "logo",
                  scaleVal: 0,
                  degrees: 45,
                },
            ...
            w(t, [
              {
                ...
                value: function () {
                  ...
                  (this.canvasWidth = this.section.outerWidth()),
                    ...
                    (this.circleEl = {
                      radius: o()(".intro-circle-element").outerWidth() / 2,
                      scaleVal: 0,
                    }),
                    (this.startAt = 3.4),
              ...
              },
              {
                ...
                value: function () {
                  var t = this;
                  (this.tl = r.ZP.timeline({
                    defaults: { ease: "none", duration: this.animDur },
                  })),
                    this.tl.fromTo(
                      this.animatedColor,
                      { value: this.colors[0] },
                    ...
                    this.tl.fromTo(
                      this.titlesWrap,
                      { y: 0 },
                      { y: -innerHeight, ease: this.animEasing, duration: 0.4 },
                      3.4
                    ),
                    this.tl.to(
                      this.circleEl,
                      ...
                      this.circleEl,
                      {
                        scaleVal:
                          innerWidth > innerHeight
                            ? (1.05 * this.canvasWidth) / this.circleEl.radius
                            : (1.05 * this.canvasHeight) / this.circleEl.radius,
                        ease: this.animEasing,
                      },
                    ...
                    this.tl.to(
                      this.circleEl,
                      {
                        scaleVal:
                          innerWidth > innerHeight
                            ? (1.5 * this.canvasWidth) / this.circleEl.radius
                            : (1.5 * this.canvasHeight) / this.circleEl.radius,
                        ease: this.animEasing,
                      },
                    ...
                    this.tl.to(
                      ...
                      { scaleVal: 1, degrees: -1.06, ease: this.animEasing },
                      this.startAt + 2 * this.animPosOffset
                    ),
                    this.tl.to(
                      this.imagesAnimValues[0],
                      {
                        ...
                        scaleVal:
                          innerWidth > innerHeight
                            ? (1.75 * this.canvasWidth) / this.images[0].width
                            : (1.75 * this.canvasHeight) / this.images[0].width,
                        ease: this.animEasing,
                        onStart: function () {
                          t.animateBgr(),
                            t.drawCircle(),
                    ...
                    this.tl.to(
                      this.imagesAnimValues[0],
                      {
                        scaleVal:
                          innerWidth > innerHeight
                            ? (2 * this.canvasWidth) / this.images[0].width
                            : (2 * this.canvasHeight) / this.images[0].width,
                        ease: this.animEasing,
                      },
                    ...
                    this.tl.to(
                      ...
                      { scaleVal: 1, ease: this.animEasing },
                      this.startAt + 3 * this.animPosOffset
                    ),
                    this.tl.to(
                      this.imagesAnimValues[1],
                      {
                        scaleVal:
                          innerWidth > innerHeight
                            ? (0.975 * this.canvasWidth) / this.images[1].width
                            : (0.975 * this.canvasHeight) /
                              this.images[1].width,
                        ease: this.animEasing,
                        onStart: function () {
                          t.animateBgr(),
                    ...
                    this.tl.to(
                      this.imagesAnimValues[1],
                      {
                        scaleVal:
                          innerWidth > innerHeight
                            ? (1.2 * this.canvasWidth) / this.images[1].width
                            : (1.2 * this.canvasHeight) / this.images[1].width,
                        ease: this.animEasing,
                      },
                    ...
                    this.tl.to(
                      this.imagesAnimValues[2],
                      {
                        ...
                        scaleVal:
                          innerWidth > innerHeight
                            ? (2 * this.canvasWidth) / this.images[2].width
                            : (2 * this.canvasHeight) / this.images[2].width,
                        ease: this.animEasing,
                        onStart: function () {
                          t.animateBgr(),
                            t.drawCanvasImage(1),
                    ...
                    this.tl.to(
                      this.imagesAnimValues[3],
                      {
                        scaleVal:
                          innerWidth > innerHeight
                            ? (1 * this.canvasWidth) / this.images[3].width
                            : (1 * this.canvasHeight) / this.images[3].width,
                        degrees: 45,
                        ease: this.animEasing,
                      },
                    ...
                    this.tl.to(
                      this.imagesAnimValues[3],
                      {
                        scaleVal:
                          innerWidth > innerHeight
                            ? (1.1 * this.canvasWidth) / this.images[3].width
                            : (1.1 * this.canvasHeight) / this.images[3].width,
                        degrees: 0,
                        ease: this.animEasing,
                      },
                    ...
                    this.tl.to(
                      ...
                      { scaleVal: 1, degrees: 0, ease: this.animEasing },
                      this.startAt + 6 * this.animPosOffset
                    ),
                    this.tl.to(
                      this.imagesAnimValues[4],
                      {
                        scaleVal:
                          innerWidth > innerHeight
                            ? (1.75 * this.canvasWidth) / this.images[4].width
                            : (1.75 * this.canvasHeight) / this.images[4].width,
                        degrees: 45,
                        ease: this.animEasing,
                        onStart: function () {
                          t.animateBgr(),
                    ...
                    this.tl.to(
                      this.imageTranslateAmount,
                      {
                        xValue: this.images[5].width,
                        yValue: this.images[5].height,
                        ease: this.animEasing,
                      },
                      this.startAt + 7 * this.animPosOffset
                    ),
                    this.tl.to(
                      this.imagesAnimValues[5],
                      {
                        scaleVal:
                          innerWidth > innerHeight
                            ? (3 * this.canvasWidth) / this.images[5].width
                            : (3 * this.canvasHeight) / this.images[5].width,
                        ease: this.animEasing,
                        onStart: function () {
                          t.animateBgr(),
                            t.drawCanvasImage(4),
                        ...
                        onComplete: function () {
                          (t.animCompleted = !0),
                            o()(window).trigger("introAnimComplete");
                        },
                      },
                      this.startAt + 7 * this.animPosOffset
                    );
                ...
                value: function () {
                  ...
                  o()(window).on("resizeObserverTrigger", function () {
                    t.animCompleted ||
                      ...
                      r.ZP.set([t.titles, t.titlesWrap], { clearProps: !0 }),
                      t.getAnimParams(),
                      t.initialAnim());
                  });
                },
              },
              {
                ...
                value: function () {
                  this.ctx.clearRect(
                    ...
                    (this.ctx.fillStyle = this.animatedColor.value),
                    this.ctx.fillRect(
                      0,
                      0,
                      this.canvas.width,
                ...
                value: function () {
                  (this.ctx.fillStyle = this.colors[1]),
                    ...
                    this.ctx.arc(
                      ...
                      (this.circleEl.radius / 2) * this.circleEl.scaleVal,
                      0,
                      2 * Math.PI
                    ),
                    this.ctx.closePath(),
              ...
              },
              {
                ...
                value: function (t) {
                  ...
                  this.ctx.save(),
                    ...
                    this.ctx.rotate(
                      (this.imagesAnimValues[t].degrees * Math.PI) / 180
                    ),
                    this.ctx.translate(
                      -this.canvas.width / 2,
                      -this.canvas.height / 2
                    ...
                    this.ctx.drawImage(
                      ...
                      this.canvas.width / 2 -
                        i / 2 -
                        this.imageTranslateAmount.xValue,
                      this.canvas.height / 2 -
                        n / 2 -
                        this.imageTranslateAmount.yValue,
                      i,
                      n
                    ),
                    this.ctx.restore();
        ...
        _ = function () {
          var t = o()(".hero-section"),
            ...
            n = (0, s.tq)()
              ? t.find(".scroll-btn-wrap")
              : i.find(".scroll-btn-wrap"),
          ...
          i.addClass("introAnimComplete"),
            r.ZP.to(
              [
                o()(".fade-in-initial"),
                c.find(".content-wrap"),
                t.find(".section-subtitle"),
              ],
              { opacity: 1, duration: 0.6, delay: 0.2, ease: "none" }
            ),
            ...
            r.ZP.fromTo(
              ...
              },
              {
                ...
                onComplete: function () {
                  W(),
                    e.addClass("no-initial-anim-styles"),
                    r.ZP.set(e, { clearProps: !0 });
                },
              }
            );
          (0, s.tq)() &&
            r.ZP.set(n, {
              bottom:
                innerHeight -
                o()(".feel-inspired-section")
                  .find(".video-wrap-el-start")
                  .offset().top +
                25,
              opacity: 1,
            }),
            ...
            r.ZP.to(o()(".header-btn").find(".btn-txt"), {
              opacity: 1,
              delay: 1,
              ease: "none",
              duration: 0.2,
        ...
        C = (function () {
          function t() {
            f(this, t),
              ...
              (this.scrollBtn = (0, s.tq)()
                ? this.heroSection.find(".scroll-btn")
                : this.section.find(".scroll-btn")),
            ...
            w(t, [
              {
                ...
                value: function () {
                  ...
                  o()(window).on("resizeObserverTrigger", function () {
                    void 0 !== t.tl && (t.tl.kill(), (t.tl = null)),
                      void 0 !== t.blocksLoopTl &&
                        (t.blocksLoopTl.kill(), (t.blocksLoopTl = null)),
              ...
              },
              {
                ...
                value: function () {
                  ...
                  (this.observer = new IntersectionObserver(function (e) {
                    e[0].isIntersecting
                      ? r.ZP.ticker.add(t.progressTween)
                      : r.ZP.ticker.remove(t.progressTween);
                  }, v)),
              ...
              },
              {
                ...
                value: function () {
                  (this.isMobile = (0, s.tq)()),
                    ...
                    this.isMobile
                      ? ((this.startPosBorderRadius = 60),
                        (this.endPosBorderRadius = 30))
                      : ((this.startPosBorderRadius =
                          innerWidth > 1024 && innerWidth <= 1920
                            ? 0.11406 * innerWidth
                            : 219),
                        (this.endPosBorderRadius =
                          innerWidth > 1024 && innerWidth <= 1920
                            ? 0.03125 * innerWidth
                            : 60));
                  var t = this.startPos.position();
                  this.startPosValues = {
                    widthVal: this.startPos.width(),
                    heightVal: this.startPos.height(),
                    topVal: t.top,
                    leftVal: t.left,
                    borderRadiusVal: Math.ceil(this.startPosBorderRadius),
                  };
                  var e = h.X.getRelativePosition(
                      this.startPos[0],
                      this.endPos[0]
                    ),
                    i = this.endPos.position();
                  (this.endPosValues = {
                    widthVal: this.endPos.width(),
                    heightVal: this.endPos.height(),
                    topVal: i.top,
                    leftVal: i.left,
                    borderRadiusVal: Math.ceil(this.endPosBorderRadius),
                    endXPos: e.x,
                    endYPos: e.y,
                  }),
                    (this.elPositionOffset = 0),
                    (this.canvasDurationOffset = this.isMobile
                      ? this.heroSectionHeight
                      : this.heroSectionHeight + this.sectionHeight),
                    (this.heroSectionAnimDuration =
                      (0.8 * this.heroSectionHeight) /
                      this.canvasDurationOffset),
                    (this.sectionContentAnimDuration =
                      (0.2 * this.heroSectionHeight) /
                      this.canvasDurationOffset),
                    (this.postSectionContentAnimDuration =
                      this.endPosValues.heightVal / this.canvasDurationOffset),
                    this.isMobile
              ...
              },
              {
                ...
                value: function () {
                  this.getAnimParams(),
                    ...
                    this.createTl(),
                    r.ZP.set(this.cardsComponentBlocks, {
                      scale: 1,
                      xPercent: 0,
                      yPercent: 0,
                    });
              ...
              },
              {
                ...
                value: function () {
                  ...
                  (this.blockScaleAmount = 0.8658),
                    (this.blockWidth = this.cardsComponentBlocks
                      .first()
                      .outerWidth()),
                    ...
                    (this.blocksLoopTl = r.ZP.timeline({
                      ...
                      defaults: {
                        ease: "power2",
                        duration: this.blocksLoopTlDuration,
                      },
                      repeat: -1,
                    ...
                    this.cardsComponentBlocks.each(function (e, i) {
                      ...
                      switch (
                        (t.blocksLoopTl.to(
                          {},
                          { duration: e > 0 ? t.pause : t.pause / 5 }
                        ),
                        t.blocksLoopTl.addLabel("blockLabel-" + e, ">"),
                        e)
                      ) {
                        case 0:
                          t.blocksLoopTl.fromTo(
                            ...
                            { scale: 1 },
                            {
                              scale: t.blockScaleAmount,
                              xPercent: 100 + t.xTranslateBy + 5,
                              yPercent: -8,
                            },
                            "blockLabel-" + e
                          ),
                            t.blocksLoopTl.to(
                              n.find(".card-item-link"),
                              { autoAlpha: 0 },
                              "blockLabel-" + e
                            ),
                            ...
                            t.blocksLoopTl.fromTo(
                              ...
                              {
                                xPercent: -t.xTranslateBy,
                                yPercent: -t.yTranslateBy,
                              },
                              "blockLabel-" + e
                            ),
                            t.blocksLoopTl.to(
                              n.next().find(".card-item-link"),
                              { autoAlpha: 1 },
                              "blockLabel-" + e
                            ),
                            t.blocksLoopTl.set(n.next(), { zIndex: 3 }, ">"),
                            t.blocksLoopTl.fromTo(
                              t.cardsComponentBlocks.last(),
                              { xPercent: 0, yPercent: 0 },
                              {
                                xPercent: -t.xTranslateBy,
                                yPercent: -t.yTranslateBy,
                            ...
                            t.blocksLoopTl.fromTo(
                              ...
                              {
                                scale: 1,
                                xPercent: 2 * t.xTranslateBy,
                                yPercent: 2 * t.yTranslateBy,
                              },
                              "backOfDeckLabel-" + e
                            );
                          break;
                        ...
                        case 2:
                          t.blocksLoopTl.fromTo(
                            ...
                            {
                              scale: t.blockScaleAmount,
                              xPercent: 105 - t.xTranslateBy,
                              yPercent: -(8 + 2 * t.yTranslateBy),
                            },
                            "blockLabel-" + e
                          ),
                            t.blocksLoopTl.to(
                  ...
                  (this.tl = r.ZP.timeline({
                    ...
                    this.tl.fromTo(
                      this.cardsStickyWrap,
                      {
                        y: -(
                          25 +
                          this.cardsStickyWrap.position().top +
                          this.cardsStickyWrap.outerHeight()
                        ),
                      },
                      { y: 0, duration: this.heroSectionAnimDuration },
                      0
                    ),
                    this.tl.fromTo(
                      this.scrollBtn,
                      { autoAlpha: 1, scale: 1 },
                      {
                        autoAlpha: 0,
                        scale: 0,
                        duration: 0.4 * this.heroSectionAnimDuration,
                      },
                      0
                    ),
                    this.tl.fromTo(
                    ...
                    this.tl.fromTo(
                      ...
                      },
                      {
                        ...
                        yPercent: 25,
                        duration: 0.5 * this.heroSectionAnimDuration,
                      },
                      0
                    ),
                    this.isMobile ||
                      ...
                      this.tl.fromTo(
                        this.cardsComponentBlocks
                          .find(".card-inner-wrap")
                          .toArray()
                          .reverse(),
                        { x: innerWidth - this.cardsComponent.offset().left },
                        {
                          x: 0,
                          duration: 0.6 * this.heroSectionAnimDuration,
                          stagger: 0.2 * this.heroSectionAnimDuration,
                          ease: "power1",
                        },
                        0
                      ),
                      ...
                      this.tl.fromTo(
                        ...
                        { autoAlpha: 0, yPercent: -25 },
                        {
                          yPercent: 0,
                          autoAlpha: 1,
                          duration: this.sectionContentAnimDuration,
                        },
                        "sectionContentLabel"
                      ),
                      this.tl.fromTo(
                      ...
                      this.tl.fromTo(
                        ...
                        {
                          yPercent: -75,
                          duration: 0.75 * this.postSectionContentAnimDuration,
                        },
                        "postSectionContentLabel+=".concat(
                          0.25 * this.postSectionContentAnimDuration
                        )
                      ),
                      this.tl.to(
                        this.visibleMedia,
                        {
                          yPercent: -75,
                          duration: this.postSectionContentAnimDuration,
                        },
                        "postSectionContentLabel"
                      ),
                      this.tl.fromTo({}, {}, { duration: 1 }, 0)),
                    (this.progressTo = r.ZP.quickTo(this.tl, "progress", {
                      ease: "power2",
                    })),
                      ...
                      if (void 0 !== e.tl) {
                        var i = (
                          (e.isMobile
                            ? document.body.scrollTop
                            : a.x.scroll.instance.scroll.y -
                              e.elPositionOffset) / e.canvasDurationOffset
                        ).toFixed(3);
                        i > 1 && (i = 1),
                          i < 0 && (i = 0),
                          t !== i && ((t = i), e.progressTo(i));
                      }
                    });
                },
              },
        ...
        T = (function () {
          function t() {
            f(this, t),
              o()(".brands-list-section").length &&
                ((this.section = o()(".brands-list-section")),
                (this.blocks = this.section.find(
                  ".brands-small-component, .brands-big-component"
                )),
          ...
          return (
            w(t, [
                ...
                value: function () {
                  ...
                  new IntersectionObserver(function (e) {
                    e[0].intersectionRatio > P.threshold &&
                      (t.section.hasClass("start-anims") ||
                        (t.section.addClass("start-anims"),
                        t.getAnimParams(),
                        t.initControls(),
                        t.createTl(),
                        t.resize()));
                ...
                value: function () {
                  ...
                  o()(window).on("resizeObserverTrigger", function () {
                    t.blockTls.forEach(function (t) {
                      void 0 !== t.tl && t.tl.kill(),
                        r.ZP.ticker.remove(t.progressTween);
                    }),
                      r.ZP.set(
                        t.blocks.find(
                          ".component-link-wrap, .colored-overlay, .content-wrap"
                        ),
                        { clearProps: !0 }
                      ),
                      t.getAnimParams(),
                      ...
                      t.blockTls.forEach(function (e) {
                        e.progressTween(),
                          y(t.section) && r.ZP.ticker.add(e.progressTween);
                      });
                  });
                },
              },
              {
                ...
                value: function (t, e, i) {
                  ...
                  if ((r.ZP.killTweensOf([s, h]), "video-block" === i)) {
                    ...
                    r.ZP.killTweensOf([
                      u.find(
                        ".component-logo-link, .big-component-item-brand-name, .w-img, .component-link"
                      ),
                      u,
                    ]),
                      "show" === e
                        ? (r.ZP.set(
                          ...
                          u.find(".swiper-slide").each(function (t, e) {
                            r.ZP.to(
                              o()(e).find(
                                ".component-logo-link, .big-component-item-brand-name, .w-img"
                              ),
                              {
                                opacity: 1,
                                scale: 1,
                        ...
                        : (r.ZP.to(u, {
                          ...
                          r.ZP.to(
                            ...
                            { opacity: 0, scale: 0.7, ease: c, duration: 0.5 }
                          ),
                          r.ZP.to(u.find(".component-link"), {
                            opacity: 0,
                            ease: c,
              ...
              },
              {
                ...
                value: function () {
                  (this.isMobile = (0, s.tq)()),
                    (this.blockPositionOffsetValues =
                      (0, s.wn)(this.section.prevAll("section")) +
                      this.section.find(".section-content-wrap").position()
                        .top),
                    (this.blockTls = []),
              ...
              },
              {
                ...
                value: function () {
                  ...
                  (this.observer = new IntersectionObserver(
                    function (e) {
                      var i = o()(e[0].target),
                        n = i.is(".brands-big-component")
                          ? "swiper-block"
                          : "video-block";
                      e[0].intersectionRatio > 0.6 &&
                      e[0].boundingClientRect.y > 0
                        ? t.animateBlock(i, "show", n)
                        : e[0].boundingClientRect.y > 0 &&
                          t.animateBlock(i, "hide", n);
                    },
                    ...
                    (this.postContentObserver = new IntersectionObserver(
                      function (e) {
                        t.blockTls.forEach(function (t) {
                          e[0].isIntersecting
                            ? r.ZP.ticker.add(t.progressTween)
                ...
                value: function () {
                  ...
                  this.blocks.each(function (e, i) {
                    var n = o()(i),
                      ...
                      h =
                        1 * n.attr("data-scroll-speed") > 0
                          ? -0.2 * innerHeight
                          : 0.1 * innerHeight,
                      c = n.position().top + t.blockPositionOffsetValues + h;
                    s.fromTo(
                      n.find(".component-link-wrap"),
                      { opacity: 1 },
                      { opacity: 0, duration: 0.25 },
                      0
                    ),
                      s.fromTo(
                        n.find(".colored-overlay"),
                        { backgroundColor: "transparent" },
                        { backgroundColor: "#202020", duration: 0.75 },
                        0
                      ),
                      s.fromTo(
                        n.find(".content-wrap"),
                        { scale: 1 },
                        { scale: 0.85, duration: 0.5 },
                        0.25
                      );
                    var l,
                      ...
                      progressTween: function () {
                        if (void 0 !== s) {
                          var e = (
                            (t.isMobile
                              ? document.body.scrollTop
                              : a.x.scroll.instance.scroll.y - c) /
                            t.canvasDurationOffset
                          ).toFixed(3);
                          e > 1 && (e = 1),
                            e < 0 && (e = 0),
                            l !== e && ((l = e), u(e));
          ...
          function t() {
            f(this, t),
              o()(".brand-storytelling-section").length &&
                ...
                (this.scrollingBlockWrap = this.section.find(
                  ".scrolling-block-wrap-outer"
                )),
                (this.nextSectionScrollingTitle = this.nextSection.find(
                  ".scrolling-title-container .scrolling-block-wrap"
                )),
                (this.nextSectionWords =
                  this.nextSection.find(".highlighted-word")),
                (this.scrollingBlockWrapChildrenToAnim = this.scrollingBlockWrap
                  .find(".lines-scrolling-container")
                  .children()),
                (this.rotatingLink = this.nextSection.find(".rotating-link")),
                (this.phoneContainer = this.nextSection.find(
            ...
            w(t, [
              {
                ...
                value: function () {
                  ...
                  new IntersectionObserver(function (e) {
                    e[0].intersectionRatio > P.threshold &&
                      (t.totalWrapper.hasClass("start-anims") ||
                        (t.totalWrapper.addClass("start-anims"),
                        t.getAnimParams(),
                        t.createTl(),
                        t.initControls(),
                        t.resize()));
                    ...
                    void 0 !== t.tl && (t.tl.kill(), (t.tl = null)),
                      ...
                      r.ZP.set(
                        [
                          ...
                          t.nextSection.find(
                            ".scrolling-title-container, .section-txt-container"
                          ),
                          ...
                          t.scrollingBlockWrap.find(
                            ".lines-scrolling-container"
                          ),
                          t.scrollingBlockWrap.find(
                            ".transform-container-inner"
                          ),
              ...
              },
              {
                key: "getAnimParams",
                value: function () {
                  r.ZP.set(this.section.find(".height-el"), {
                    paddingTop: "".concat(
                      (innerHeight / innerWidth) * 100,
                      "%"
                    ),
                  }),
                    ...
                    r.ZP.set("#fix-overlay-block", {
                      height:
                        0.33 * innerHeight +
                        (innerHeight - this.scrollingBlockWrap.outerHeight()) /
                          2 +
                        2 * this.scrollingBlockWrap.outerHeight() +
                        (this.section.find(".max-w-container").outerHeight() -
                          this.section.find(".max-w-container").height()) /
                          2,
                    }),
                    r.ZP.set("#fix-overlay-block-2", {
                      height: Math.ceil(
                        0.33 * innerHeight +
                          this.titleSectionHeight +
                          this.nextSection.find(".scroll-wrap").outerHeight()
                      ),
                    }),
                    r.ZP.set(this.nextSection.find(".scroll-wrap-inner"), {
                      y: -Math.ceil(this.titleSectionHeight),
                    }),
                    (this.transformBy =
                      0.4 * -this.scrollingBlockWrap.outerWidth()),
                    (this.isMobile = (0, s.tq)()),
                    (this.elPositionOffset =
                      (0, s.wn)(this.totalWrapper.prevAll("section")) -
                      innerHeight),
                    (this.canvasDurationOffset = this.sectionHeight),
                    (this.titleAnimDuration =
                      this.section.outerHeight() / this.sectionHeight),
                    (this.postTitleAnimDuration =
                      innerHeight / this.sectionHeight),
                    (this.showNextContentDuration =
                      (0.33 * innerHeight) / this.sectionHeight),
                    (this.phoneAnimDuration =
                      this.phoneContainer.outerHeight() / this.sectionHeight),
                    (this.postPhoneAnimDuration =
                      innerHeight / this.sectionHeight),
                    a.x.update();
                },
              },
              {
                ...
                value: function (t) {
                  this.section
                    .find("[data-manual-scrolling-anim]")
                    .each(function (e, i) {
                      o()(window).trigger("scrollingAnimHandler", {
                        state: t,
                        element: o()(i),
                      });
                    });
                ...
                value: function () {
                  ...
                  (this.tl = r.ZP.timeline({
                    ...
                    this.tl.fromTo(
                      ...
                      {
                        clipPath: "polygon(0% 0%, 100% 0%, 100% 100%, 0% 100%)",
                        duration: 0.5 * this.titleAnimDuration,
                      },
                      0
                    );
                  var e = 0.1 * this.titleAnimDuration;
                  this.tl.fromTo(
                    this.scrollingBlockWrap,
                    { yPercent: 50 },
                    { yPercent: 0, duration: 0.75 * this.titleAnimDuration },
                    e
                  ),
                    this.tl.fromTo(
                      this.scrollingBlockWrapChildrenToAnim,
                      { x: this.transformBy },
                      { x: 0, duration: 0.75 * this.titleAnimDuration },
                      e
                    ),
                    this.tl.fromTo(
                      {},
                    ...
                    this.tl.fromTo(
                      this.scrollingBlockWrap.find(".scrolling-bgc-el"),
                      {
                        borderRadius: function () {
                          return innerWidth > 1024 && innerWidth < 1921
                            ? 0.03125 * innerWidth
                            : innerWidth > 1920
                            ? 60
                            : void 0;
                      ...
                      },
                      {
                        borderRadius: 0,
                        scaleX:
                          innerWidth / this.scrollingBlockWrap.outerWidth(),
                        scaleY:
                          innerHeight / this.scrollingBlockWrap.outerHeight(),
                        duration: this.postTitleAnimDuration,
                      },
                      "scrollingBlockWrapScale"
                    ),
                    this.tl.fromTo(
                      this.scrollingBlockWrap.find(
                        ".lines-scrolling-container"
                      ),
                      { opacity: 1 },
                      {
                        opacity: 0,
                        duration: 0.5 * this.postTitleAnimDuration,
                      },
                      "scrollingBlockWrapScale"
                    ),
                    this.tl.fromTo(
                    ...
                    this.tl.fromTo(
                      this.nextSection.find(
                        ".scrolling-title-container, .section-txt-container"
                      ),
                      { opacity: 0 },
                      {
                        opacity: 1,
                        duration: 0.4 * this.showNextContentDuration,
                        stagger: 0.1 * this.showNextContentDuration,
                      },
                      ">"
                    ),
                    ...
                    this.tl.fromTo(
                      ...
                      {},
                      {
                        ...
                        onComplete: function () {
                          o()(window).trigger("scrollingAnimHandler", {
                            state: "play",
                            element: t.nextSectionScrollingTitle,
                          }),
                            t.nextSectionWords
                              .filter(".word-1, .word-2, .word-3")
                              .addClass("fade-in-bgr"),
                            t.nextSection
                              .find(".dots-element")
                              .addClass("animate-dots");
                        },
                        onReverseComplete: function () {
                          o()(window).trigger("scrollingAnimHandler", {
                            state: "reverse",
                            ...
                            t.nextSectionWords
                              .filter(".word-1, .word-2, .word-3")
                              .removeClass("fade-in-bgr"),
                            t.nextSection
                              .find(".dots-element")
                              .removeClass("animate-dots");
                        },
                      },
                    ...
                    this.tl.fromTo(
                      ...
                      {
                        opacity: 1,
                        duration: 0.5 * this.showNextContentDuration,
                      },
                      "showNextContentLabel+=".concat(
                        0.5 * this.showNextContentDuration
                      )
                    ),
                    this.tl.fromTo(
                    ...
                    this.tl.fromTo(
                      this.phoneContainer.find(".section-info-title"),
                    ...
                    this.tl.fromTo(
                      ...
                      { opacity: 0, scale: 0.5 },
                      {
                        ...
                        duration: this.phoneAnimDuration,
                        onComplete: function () {
                          return o()(window).trigger("rotatingLinkAnim", {
                            state: "play",
                          });
                        },
                        onReverseComplete: function () {
                    ...
                    this.tl.fromTo(
                      this.phoneSVG,
                      { scale: 2 },
                      { scale: 1, duration: this.phoneAnimDuration },
                      "phoneAnimationLabel"
                    );
                  var i,
                    n =
                  ...
                  this.tl.fromTo(
                    ...
                    this.tl.fromTo(
                      ...
                      {
                        borderRadius: 0.0729 * this.phoneContainer.outerWidth(),
                        scale: 0.4,
                        duration: this.postPhoneAnimDuration,
                      },
                    ...
                    this.tl.fromTo(
                      this.phoneContainer.children(),
                      { opacity: 1 },
                      {
                        opacity: 0,
                        duration: 1 * this.postPhoneAnimDuration,
                        ease: "power3.in",
                      },
                      "postPhoneAnimationLabel"
                    ),
                      ...
                      if (void 0 !== t.tl) {
                        var e = (
                          (t.isMobile
                            ? document.body.scrollTop
                            : a.x.scroll.instance.scroll.y -
                              t.elPositionOffset) / t.canvasDurationOffset
                        ).toFixed(3);
                        e > 1 && (e = 1),
                          e < 0 && (e = 0),
                          i !== e && ((i = e), t.progressTo(e));
                      }
                    });
                },
              },
        ...
        V = function () {
          ...
          c.fromTo(
            ...
            c.fromTo(
              ...
              { transformOrigin: "50% 50%", yPercent: -2, duration: 0.5 },
              0
            ),
            c.fromTo(
              a,
              { transformOrigin: "50% 50%", yPercent: -2 },
              { transformOrigin: "50% 50%", yPercent: 0, duration: 0.5 },
              0.5
            ),
            c.fromTo(
              a,
              { transformOrigin: "50% 50%", xPercent: 0 },
              { transformOrigin: "50% 50%", xPercent: 29 },
              0
            ),
            c.fromTo(
              e.find(".phone-rect-flat"),
          ...
          i.on(t ? "touchmove touchstart touchend" : "mousemove", function (e) {
            t
              ? ((l =
                ...
                (d = (l.clientX / innerWidth).toFixed(3)))
              : (d = (e.pageX / innerWidth).toFixed(3)),
              u(d);
          });
          var g = r.ZP.to(n.children(), {
            rotation: "+=720",
            duration: 10,
            ease: "none",
            repeat: -1,
            ...
            w(t, [
                ...
                value: function () {
                  ...
                  this.blocks.on("mouseenter", function (e) {
                    ...
                    r.ZP.killTweensOf(i.find(".block-transform-wrap")),
                      (t.blockLastRotation[i.index()] = r.ZP.getProperty(
                        e.currentTarget,
                        "rotation"
                      )),
                      r.ZP.to(i.find(".block-transform-wrap"), {
                        rotation: -1 * t.blockLastRotation[i.index()],
                        duration: 1,
                        xPercent: 0,
                        ease: "power2",
                      }),
                      i.prev().length &&
                        r.ZP.to(i.prev().find(".block-transform-wrap"), {
                          xPercent: -25,
                          duration: 1,
                          ease: "power2",
                        }),
                      i.next().length &&
                        r.ZP.to(i.next().find(".block-transform-wrap"), {
                          xPercent: 25,
                          duration: 1,
                          ease: "power2",
                        });
                    ...
                    this.blocks.on("mouseleave", function (e) {
                      r.ZP.killTweensOf(t.blocks.find(".block-transform-wrap")),
                        r.ZP.to(t.blocks.find(".block-transform-wrap"), {
                          xPercent: 0,
                          rotation: 0,
                          duration: 1,
                          ease: "power2",
                  ...
                  new IntersectionObserver(function (e) {
                    e[0].intersectionRatio > P.threshold &&
                      (t.section.hasClass("start-anims") ||
                        ...
                        t.getAnimParams(),
                        t.isMobile ||
                          (t.createTl(), t.initControls(), t.blocksHoverAnim()),
                        t.followCursor(),
                        t.resize()));
                  }, P).observe(this.section[0]);
                },
                  ...
                  o()(window).on(
                    ...
                    function (o) {
                      n.isMobile &&
                        ...
                        (e = t.clientX),
                        (i = t.clientY));
                      var r = h.X.getRelativePosition(
                        n.cursor.parent()[0],
                        window,
                        [0.5, 0.5],
                        {
                          x: n.isMobile ? e : o.pageX,
                          y: n.isMobile ? i : o.pageY,
                        }
                      );
                      r.x < n.rightEnd && r.x > n.leftEnd
                        ? s(r.x)
                        : (r.x > n.rightEnd && s(n.rightEnd),
                          r.x < n.leftEnd && s(n.leftEnd)),
                        r.y < n.bottomEnd && r.y > n.topEnd
                          ? a(r.y)
                          : (r.y > n.bottomEnd && a(n.bottomEnd),
                            r.y < n.topEnd && a(n.topEnd));
                    }
                  );
                },
              },
              {
                ...
                value: function () {
                  ...
                  (this.isMobile = (0, s.tq)()),
                    (this.elPositionOffset =
                      (0, s.wn)(this.section.prevAll("section")) - innerHeight),
                    (this.canvasDurationOffset =
                      this.section.outerHeight() -
                      this.section.find(".post-txt-content").outerHeight() +
                      0.9 * innerHeight),
                    (this.transformBy =
                      0.4 * -this.scrollingBlockWrap.outerWidth()),
                    (this.cursor = o()(".eye-el")),
                    (this.thisCursorWidth = this.cursor.width() / 2),
                    (this.cursorParentValues = {
                      width: this.cursor.parent().outerWidth(),
                      height: this.cursor.parent().outerHeight(),
                    }),
                    (this.cursorParentCornerOffsetVal = Math.round(
                      0.03984 * this.cursorParentValues.width
                    )),
                    (this.leftEnd =
                      -this.cursorParentValues.width / 2 +
                      this.thisCursorWidth +
                      this.cursorParentCornerOffsetVal),
                    (this.rightEnd =
                      this.cursorParentValues.width / 2 -
                      this.thisCursorWidth -
                      this.cursorParentCornerOffsetVal),
                    (this.topEnd =
                      -this.cursorParentValues.height / 2 +
                      this.thisCursorWidth +
                      this.cursorParentCornerOffsetVal),
                    (this.bottomEnd =
                      this.cursorParentValues.height / 2 -
              ...
              },
              {
                key: "animateEyeWrap",
                value: function (t) {
                  r.ZP.to(this.section.find(".eye-wrap"), {
                    scale: t,
                    ease: "power2",
                    duration: 1,
                  });
              ...
              },
              {
                ...
                value: function () {
                  ...
                  (this.tl = r.ZP.timeline({
                    paused: !0,
                    defaults: { ease: "none", duration: 0.75 },
                  })),
                    this.tl.fromTo(
                      this.titles,
                      { clipPath: "polygon(0% 0%, 100% 0%, 100% 0%, 0% 0%)" },
                    ...
                    this.tl.fromTo(
                      this.scrollingBlockWrap.children(),
                      { x: this.transformBy },
                      { x: 0, duration: 0.5 },
                      0.25
                    ),
                    ...
                    this.blocks.each(function (t, i) {
                      ...
                      t < e.blocks.length / 2
                        ? e.tl.fromTo(
                            ...
                            {
                              x: -s,
                              rotation: parseInt(n.attr("data-from-rotation")),
                            },
                            {
                              x: 0,
                              ...
                              duration: 1.5,
                              onUpdate: function () {
                                return (e.blockLastRotation[t] =
                                  r.ZP.getProperty(i, "rotation"));
                              },
                            },
                            0
                          )
                      ...
                      e.blocks.length,
                        e.tl.fromTo(
                          ...
                          { rotation: 1 * n.attr("data-default-rotation") },
                          {
                            ...
                            duration: 0.5,
                            onUpdate: function () {
                              return (e.blockLastRotation[t] = r.ZP.getProperty(
                                i,
                                "rotation"
                              ));
                            },
          ...
          function t() {
            f(this, t),
              o()(".marketing-seo-section").length &&
                ...
                (this.bgcEl = o()("body")),
                (this.sectionTitleWrap = this.section.find(
                ...
                (this.blocksInnerWrap =
                  this.section.find(".blocks-inner-wrap")),
                    ...
                    void 0 !== t.tl && (t.tl.kill(), (t.tl = null)),
                      ...
                      r.ZP.set(
                        [
                          ...
                          t.scrollingBlockWrap.children(),
                          t.pagination,
                          t.pagination.children(),
                          t.txtItemsWrap,
                          t.txtItemsWrap.parent(),
                          t.txtItems,
                          t.imgItems,
                          "#logoCanvas",
                        ],
                  ...
                  (this.isMobile = (0, s.tq)()),
                    (this.sectionPaddingTop =
                      ...
                      this.section
                        ...
                        .css("padding-top")
                        .split("px")[0]),
                    (this.stickyBlockHalfOffset =
                      (innerHeight - this.blocksInnerWrap.height()) / 2),
                    (this.elPositionOffset =
                      (0, s.wn)(this.section.prevAll("section")) - innerHeight),
                    (this.canvasDurationOffset =
                      this.section.outerHeight() + innerHeight),
                    (this.sectionHeight = this.canvasDurationOffset),
                    (this.pause1 =
                      (this.blocksInnerWrap.parent().position().top +
                        this.blocksInnerWrap.position().top) /
                      this.sectionHeight),
                    (this.titleAnimDuration = this.pause1),
                    (this.pause2 =
                      this.stickyBlockHalfOffset / this.sectionHeight),
                    (this.introContentDuration =
                      this.blocksInnerWrap.height() / this.sectionHeight),
                    (this.blocksContentDuration =
                      (t + this.stickyBlockHalfOffset) / this.sectionHeight),
                    (this.transformBy =
                      0.4 * -this.scrollingBlockWrap.outerWidth()),
                    this.blockOffset,
                    innerWidth > 1024 && innerWidth < 1921
                      ? (this.blockOffset = 0.09479 * innerWidth)
                      : innerWidth > 1920 && (this.blockOffset = 182),
                    this.isMobile ||
                      r.ZP.set(this.imgItems.find("video, img"), {
                        width: this.imgItemsWrap.outerWidth(),
                        height: this.imgItemsWrap.outerHeight(),
                      });
                },
              },
              {
                ...
                value: function () {
                  ...
                  this.txtItems.each(function (e, i) {
                    if (0 !== e) {
                      var n = o()(i),
                        a =
                          (0, s.wn)(n.prevAll(".txt-item")) + t.blockOffset * e;
                      r.ZP.set(n, { y: a });
                    }
                  });
                },
                ...
                value: function () {
                  ...
                  (this.tl = r.ZP.timeline({
                    ...
                    this.tl.fromTo(
                      ...
                      {
                        clipPath: "polygon(0% 0%, 100% 0%, 100% 100%, 0% 100%)",
                        stagger: 0.1 * this.titleAnimDuration,
                        duration: 0.8 * this.titleAnimDuration,
                      },
                      0
                    ),
                    this.tl.fromTo(
                      this.scrollingBlockWrap,
                      { autoAlpha: 0 },
                      { autoAlpha: 1, duration: 0.5 * this.titleAnimDuration },
                      0.5 * this.titleAnimDuration
                    ),
                    this.tl.fromTo(
                      this.scrollingBlockWrap.children(),
                      { x: this.transformBy },
                      { x: 0, duration: 0.5 * this.titleAnimDuration },
                      0.5 * this.titleAnimDuration
                    ),
                    this.tl.fromTo(
                      {},
                    ...
                    this.tl.fromTo(
                      this.imgItems.first().find("video, img"),
                      { opacity: 0 },
                      { opacity: 1, duration: this.introContentDuration },
                      "introContentAnimationLabel"
                    ),
                    this.tl.fromTo(
                      this.section.find(".media-content-wrap"),
                      { backgroundColor: "rgba(0,0,0,1)" },
                      {
                        backgroundColor: "rgba(0,0,0,0)",
                        duration: this.introContentDuration,
                      },
                      "introContentAnimationLabel"
                    ),
                    this.tl.fromTo(
                    ...
                    this.tl.fromTo(
                      this.txtItemsWrap.parent(),
                      { y: 0.5 * innerHeight },
                      { y: 0, duration: this.introContentDuration },
                      "introContentAnimationLabel"
                    ),
                  ...
                  this.txtItems.each(function (e, n) {
                    if (0 !== e) {
                      ...
                      t.tl.to(
                        ...
                        t.tl.fromTo(
                          a.find(".media-content-wrap"),
                          { height: "20%" },
                          { height: "100%", duration: i },
                          h
                        );
                    }
                  }),
          ...
          function t() {
            f(this, t),
              o()(".services-section").length &&
                ...
                (this.servicesContainer = this.section.find(
                  ".services-container"
                )),
                  ...
                  o()(window).on("resizeObserverTrigger", function () {
                    void 0 !== t.tl && (t.tl.kill(), (t.tl = null)),
                      ...
                      r.ZP.set(
                        [
                          t.allTitles,
                          t.section.find(".transform-wrap"),
                          t.section.find(".title-offset-wrap"),
                          t.servicesContainer,
                        ],
                        { clearProps: !0 }
                      ),
              ...
              },
              {
                ...
                value: function () {
                  ...
                  this.services.on("mouseenter", function (e) {
                    ...
                    this.section.on(
                      "mouseenter",
                      "[data-manual-scrolling-anim]",
                      function (t) {
                        var e = o()(t.currentTarget);
                        r.ZP.killTweensOf([
                          e,
                          e.parent().find(".services-item-title"),
                        ]),
                          o()(window).trigger("scrollingAnimHandler", {
                            state: "play",
                            element: e,
                          }),
                          r.ZP.to(e.parent().find(".services-item-title"), {
                            opacity: 0,
                            ease: "none",
                            duration: 0.3,
                          }),
                  ...
                  var g = (0, s.tq)();
                  this.servicesContainer.on(
                    g ? "touchmove touchstart touchend" : "mousemove",
                    function (t) {
                      g
                        ? ((e =
                    ...
                    g &&
                      o()("body").on("scroll", function () {
                        t.imgChildrenContainer.hasClass("hidden-container") ||
                          (t.imgChildrenContainer.addClass("hidden-container"),
                          d());
                      }),
              ...
              },
              {
                ...
                value: function () {
                  ...
                  (this.tl = r.ZP.timeline({
                    ...
                    this.tl.fromTo(
                      this.section.find(".transform-wrap"),
                      { y: 3 * this.mainTitleHeight },
                      { y: 0, ease: "power1" },
                      0
                    ),
                    ...
                    this.tl.fromTo(
                      this.allTitles.not(this.mainTitle),
                      { opacity: 1 },
                      { opacity: 0, duration: 0.25 },
                      0.5
                    ),
                    this.tl.fromTo(
                      this.section.find(".title-offset-wrap"),
                      { borderColor: "rgba(0,0,0, 0)" },
                      { borderColor: "rgba(0,0,0, 1)", duration: 0.25 },
                      0.5
                    ),
                    this.tl.fromTo(
            ...
            f(this, t),
              o()(".key-performance-indicators-section").length &&
                ...
                (this.image = {
                  src:
                    _root +
                    "images/key-performance-indicators-section/Bharat Innovstions-logo.svg",
                }),
                (this.isEventInit = !1),
                this.initialStartHandler());
          }
            ...
            w(t, [
              {
                key: "initialStartHandler",
                value: function () {
                  this.section.addClass("start-anims"),
                    this.getAnimParams(),
                    this.loadImages();
                },
              },
              ...
              },
              {
                ...
                value: function () {
                  var t = this,
                    ...
                    w = 200;
                  (this.lastPositionX = 0.1 * this.canvasWidth),
                    (this.lastPositionY = 0.5 * -this.canvasHeight);
                  (this.svgsToLoad = [
                    _root +
                      "images/key-performance-indicators-section/new/bottle_1.svg?v=.1",
                    _root +
                      "images/key-performance-indicators-section/new/bottle_2.svg?v=.1",
                    _root +
                      "images/key-performance-indicators-section/new/ellipse_1.svg?v=.1",
                    _root +
                      "images/key-performance-indicators-section/new/ellipse_2.svg?v=.1",
                    _root +
                      "images/key-performance-indicators-section/new/pack_1.svg?v=.1",
                    _root +
                      "images/key-performance-indicators-section/new/pack_2.svg?v=.1",
                    _root +
                      "images/key-performance-indicators-section/new/star_1.svg?v=.1",
                    _root +
                      "images/key-performance-indicators-section/new/triangle_1.svg?v=.1",
                    _root +
                      "images/key-performance-indicators-section/Bharat Innovstions-logo.svg?v=.1",
                  ]),
                    (this.loadedSvgs = []),
                    (this.responsiveSvgWidth =
                      innerWidth > 1024 && innerWidth <= 1920
                        ? 0.11458
                        : 110 / 1024),
                    innerWidth > 1920 &&
                      (this.responsiveSvgWidth = 220 / innerWidth);
                  var S = function () {
                    (t.svgBodies = []),
                      (t.bodiesArray = []),
                      t.loadedSvgs.forEach(function (e, i) {
                        ...
                        void 0 === a && (a = "black"),
                          void 0 === h && (h = a),
                          n.hasClass("Bharat Innovstions-logo") &&
                            ((a = "transparent"), (h = "transparent")),
                          t.lastPositionX + 330 * s >= innerWidth
                            ? ((t.lastPositionX = 0.1 * t.canvasWidth),
                              (t.lastPositionY += r * s))
                            : (t.lastPositionX += 330 * s);
                        var u = g.fromVertices(
                          n.hasClass("Bharat Innovstions-logo")
                            ? (1.009 * t.canvasWidth) / 2
                            : t.lastPositionX,
                          n.hasClass("Bharat Innovstions-logo")
                            ? 1.035 * t.image.topVal
                            : t.lastPositionY,
                          e.vertices,
                          {
                            render: {
                        ...
                        l().Body.scale(u, s, s),
                          n.hasClass("Bharat Innovstions-logo")
                            ...
                            : ((u.KPITextContent = n.attr("data-text")),
                              l().Body.setPosition(u, {
                                x: u.position.x + t.randomNumber(200),
                                y: u.position.y + t.randomNumber(200),
                              }),
                              (u.velocity.x = 2 * Math.random() - 1),
                              (u.velocity.y = 2 * Math.random() - 1)),
                          t.svgBodies.push({
                            x: n.hasClass("Bharat Innovstions-logo")
                              ? (1.009 * t.canvasWidth) / 2
                              : t.lastPositionX,
                            y: n.hasClass("Bharat Innovstions-logo")
                              ? 1.035 * t.image.topVal
                              : t.lastPositionY,
                            body: u,
                            svg: n,
                          ...
                          c.add(p.world, u),
                          n.hasClass("Bharat Innovstions-logo") ||
                            t.bodiesArray.push(u);
                      }),
                      (t.ground = g.rectangle(
                        t.canvasWidth / 2,
                        t.canvasHeight + 100,
                        5 * t.canvasWidth,
                        w,
                      ...
                      (t.ceiling = g.rectangle(
                        t.canvasWidth / 2,
                        -(3 * t.canvasHeight + 100),
                        5 * t.canvasWidth,
                        w,
                        m
                      )),
                  ...
                  t.svgsToLoad.forEach(function (e, i) {
                    ...
                    fetch(n)
                      ...
                      t.loadedSvgs.push({ vertices: i, svg: e }),
                  ...
                  o()(window)
                    ...
                    .on("matterJSControl", function (t, e) {
                      "start" === e.state
                        ? (l().Render.run(f), l().Runner.run(y, p))
                        : (l().Render.stop(f), l().Runner.stop(y));
                    }),
                    o()(window)
                    ...
                    o()(window)
                      ...
                      .on("resizeMatterJS", function () {
                        (f.canvas.width = t.canvasWidth),
                          ...
                          (t.responsiveSvgWidth =
                            innerWidth > 1024 && innerWidth <= 1920
                              ? 0.11458
                              : 110 / 1024),
                          innerWidth > 1920 &&
                            (t.responsiveSvgWidth = 220 / innerWidth),
                ...
                value: function () {
                  ...
                  this.svgBodies.forEach(function (e) {
                    l().Body.setPosition(e.body, { x: e.x, y: e.y }),
                      e.svg.hasClass("Bharat Innovstions-logo") ||
                        (l().Body.setPosition(e.body, {
                          x: e.body.position.x + t.randomNumber(5),
                          y: e.body.position.y + t.randomNumber(5),
                        }),
              ...
              },
              {
                ...
                value: function () {
                  ...
                  (this.observer = new IntersectionObserver(function (e) {
                    e[0].isIntersecting
                      ? (r.ZP.ticker.add(t.progressTween),
                        o()(window).trigger("matterJSControl", {
                          state: "start",
                        }))
                      : (r.ZP.ticker.remove(t.progressTween),
                        o()(window).trigger("matterJSControl", {
              ...
              },
              {
                ...
                value: function () {
                  (this.isMobile = (0, s.tq)()),
                    (this.contentWrapHeight = this.section
                      .find(".outer-content-wrap")
                      .outerHeight()),
                    (this.canvasWidth = this.section.outerWidth()),
                    ...
                    (this.canvas.height = Math.ceil(this.canvasHeight)),
                    (this.image.leftVal =
                      this.imgContentWrap.offset().left +
                      this.imgContentWrap.width() / 2),
                    (this.image.topVal =
                      this.imgContentWrap.position().top +
                      this.imgContentWrap.height() / 2),
                  ...
                  (this.scaleVal = {
                    imageVal: e,
                    canvasVal: t / (this.image.heightVal * e * 0.075),
                  }),
                    r.ZP.set("#fix-overlay-block-6", {
                      height:
                        this.contentWrapHeight +
                        this.servicesSection.outerHeight(),
                    }),
                    (this.elPositionOffset =
                      (0, s.wn)(this.section.prevAll("section")) -
                      innerHeight +
                      0.65 * this.contentWrapHeight),
              ...
              },
              {
                ...
                value: function () {
                  ...
                  var t = Math.ceil(
                      this.image.widthVal * this.scaleVal.imageVal
                    ),
                    e = Math.ceil(
                      this.image.heightVal * this.scaleVal.imageVal
                    );
                  this.ctx.setTransform(
                    ...
                    this.scaleVal.canvasVal,
                    this.image.leftVal -
                      this.scaleVal.canvasVal * this.image.leftVal,
                    this.image.topVal -
                      this.scaleVal.canvasVal * this.image.topVal
                  ),
                    this.ctx.drawImage(
                      this.image.imgEl,
                      this.image.leftVal - t / 2,
                      this.image.topVal - e / 2,
                      t,
                      e
                    );
                },
                ...
                value: function () {
                  ...
                  (this.tl = r.ZP.timeline({
                    ...
                    this.tl.fromTo(
                      this.scaleVal,
                      {
                        canvasVal: this.scaleVal.canvasVal,
                        imageVal: this.scaleVal.imageVal,
                      },
                      {
                        canvasVal: 1,
                        imageVal: 1,
                    ...
                    this.tl.to(
                      {},
                      {
                        ...
                        ease: "none",
                        onStart: function () {
                          o()(window).trigger("matterJSAnimControl", {
                            state: "start",
                          });
                        },
                        onReverseComplete: function () {
          ...
          function t() {
            f(this, t),
              o()(".clients-love-work-section").length &&
                ...
                (this.prevSection = o()(
                  ".key-performance-indicators-section .color-wrap"
                )),
                (this.titleWrap = this.section.find(".title-wrap")),
                (this.animTitle = this.section.find(".anim-title")),
                (this.introAnimContent = this.section.find(
                  ".section-title:not(.anim-title), .blocks-wrap"
                )),
            ...
            w(t, [
              {
                ...
                value: function () {
                  ...
                  new IntersectionObserver(function (e) {
                    e[0].intersectionRatio > P.threshold &&
                      (t.prevSection.hasClass("start-anims") ||
                        (t.prevSection.addClass("start-anims"),
                        t.positionBlocks(),
                        t.getAnimParams(),
                        t.createTl(),
                        t.initControls(),
              ...
              },
              {
                ...
                value: function () {
                  (this.step = 0),
                    (this.isMobile = (0, s.tq)()),
                    (this.sectionHeight = this.section.outerHeight()),
                    (this.sectionPaddingTop = this.section
                      .find(".max-w-container")
                      .position().top),
                    (this.elPositionOffset =
                      (0, s.wn)(this.section.prevAll("section")) - innerHeight),
                    (this.canvasDurationOffset =
                      this.sectionHeight + innerHeight),
                    (this.heightDiff =
                      this.contentWrap.outerHeight() - innerHeight),
                    (this.contentDuration =
                      (0.75 * innerHeight) / this.canvasDurationOffset),
                    (this.beforeBlocksPause =
                      (0.25 * innerHeight) / this.canvasDurationOffset),
                    (this.blocksDuration =
                      innerHeight /
                      this.canvasDurationOffset /
                      (this.blocks.length - 1)),
                    (this.postSectionDuration =
                      this.contentWrap.outerHeight() /
                      this.canvasDurationOffset);
                },
              },
              {
                ...
                value: function () {
                  ...
                  (this.tl = r.ZP.timeline({
                    ...
                    this.tl.fromTo(
                      ...
                      {
                        onReverseComplete: function () {
                          r.ZP.killTweensOf(t.heart),
                            r.ZP.to(t.heart, { scale: 1 });
                        },
                        duration: 0.01 * this.contentDuration,
                      },
                    ...
                    this.tl.fromTo(
                      {},
                      {},
                      { duration: this.beforeBlocksPause },
                      ">"
                    );
                  for (
                    var e = function (e) {
                  ...
                  this.tl.to(
                    s,
                    {
                      y: "-=".concat(0.6 * innerHeight),
                      duration:
                        this.postSectionDuration -
                        h * (0.075 * this.postSectionDuration),
                      stagger: 0.075 * this.postSectionDuration,
                    },
                    ">"
                  ),
                    this.tl.fromTo({}, {}, { duration: 1 }, 0),
                    ...
                    void 0 !== t.tl && (t.tl.kill(), (t.tl = null)),
                      ...
                      r.ZP.set(
                        [
                          ...
                          t.borderEl,
                          t.blocksWrap,
                          t.section.find(".max-w-container"),
                          t.section.find(".scroll-outer-wrap"),
                          t.section.find(".title-wrap"),
                        ],
                        { clearProps: !0 }
                      ),
                      t.getAnimParams(),
                  ...
                  (this.tl = r.ZP.timeline({
                    ...
                    this.tl.fromTo(
                      ...
                      { width: "40%", opacity: 0 },
                      {
                        width: "100%",
                        opacity: 1,
                        duration: 0.35 * this.contentDuration,
                      },
                      0.65 * this.contentDuration
                    ),
                    this.tl.fromTo(
                      this.section.find(".fade-in-wrap"),
                      { opacity: 0 },
                      { opacity: 1, duration: 0.35 * this.contentDuration },
                      0.5 * this.contentDuration
                    ),
                    this.tl.fromTo(
                      this.blocksWrap,
                    ...
                    this.tl.fromTo(
                      this.section.find(".max-w-container"),
                      { y: 0 },
                      {
                        y: 0.2 * this.section.outerHeight(),
                        duration: 0.5 * this.postSectionDuration,
                      },
                      "postSectionAnimLabel"
                    ),
                    this.tl.fromTo(
                      this.section.find(".scroll-outer-wrap"),
                      { opacity: 1 },
                      { opacity: 0, duration: 0.5 * this.postSectionDuration },
                      "postSectionAnimLabel"
                    ),
                    this.tl.fromTo(
          ...
          function t() {
            f(this, t),
              o()(".cpg-contact-section").length &&
                ...
                (this.bannerInfoTitle = this.section.find(
                  ".post-banner-info-title"
                )),
                (this.titleLines = this.section.find(
                  ".section-title.abs-cover-el .line-outer"
                )),
                this.initialStartHandler());
          }
          return (
                    ...
                    void 0 !== t.tl && (t.tl.kill(), (t.tl = null)),
                      ...
                      r.ZP.set(
                        [
                          ...
                          t.bannerInfoTitle,
                          t.section.find(
                            ".section-info-title, .scroll-outer-wrap"
                          ),
                          t.section.find(".section-title:not(.abs-cover-el)"),
                          t.titleLines,
                          t.bannerTitle,
                          t.bannerBtn,
                        ],
              ...
              },
              {
                ...
                value: function () {
                  (this.isMobile = (0, s.tq)()),
                    ...
                    (this.canvasDurationOffset = this.sectionHeight),
                    (this.contentDuration =
                      (0.5 * innerHeight) / this.canvasDurationOffset),
                    (this.pauseDuration =
                      (0.5 * innerHeight) / this.canvasDurationOffset),
                    (this.finalDuration =
                      (this.sectionHeight - innerHeight) /
                ...
                value: function () {
                  ...
                  (this.tl = r.ZP.timeline({
                    ...
                    this.tl.fromTo(
                      ...
                      {
                        onComplete: function () {
                          r.ZP.to([e.bannerTitle, e.bannerBtn], {
                            opacity: 1,
                            ease: "none",
                            duration: 0.4,
                          }),
                            r.ZP.to(e.bannerInfoTitle, {
                              opacity: 1,
                              y: 0,
                              ease: "power2",
                              duration: 0.4,
                            ...
                            r.ZP.to(
                              e.section.find(
                                ".section-title:not(.abs-cover-el)"
                              ),
                              {
                                opacity: 0.33,
                                delay: 0.15,
                        ...
                        onReverseComplete: function () {
                          r.ZP.to([e.bannerTitle, e.bannerBtn], {
                            ...
                            r.ZP.to(
                              [
                                e.section.find(
                                  ".section-info-title, .section-title:not(.abs-cover-el)"
                                ),
                                e.section.find(".scroll-outer-wrap"),
                              ],
                              { opacity: 0, ease: "none" }
                            );
                        },
                    ...
                    this.tl.fromTo(
                      ...
                      {
                        clipPath: "polygon(0% 0%, 100% 0%, 100% 100%, 0% 100%)",
                        duration: this.finalDuration / this.titleLines.length,
                        stagger: this.finalDuration / this.titleLines.length,
                      },
                      "<"
                    ),
                    this.tl.fromTo({}, {}, { duration: 1 }, 0),
                  ...
                  o()(window).on("resizeObserverTrigger", function () {
                    (e.isMobile = (0, s.tq)()),
                      e.observerTls.forEach(function (i, n) {
                        t.is(o()(i.observeTarget)) &&
                          (e.observer.unobserve(i.observeTarget),
                          "undefined" != typeof е &&
                            void 0 !== е.tl &&
                            (i.tl.kill(),
                            (i.tl = null),
                            e.observerTls.splice(n, 1)));
                      }),
                      e.eventTls.forEach(function (i, n) {
                        i.section.parents("section").is(t) &&
                          "undefined" != typeof е &&
                          void 0 !== е.tl &&
                          (i.tl.kill(), (i.tl = null), e.eventTls.splice(n, 1));
                      });
                    var i = e.isMobile
                      ? ".scrolling-block-wrap"
                      : ".scrolling-block-wrap:not(.stop-scroll-anim-desktop)";
                    t.find(i).each(function (t, i) {
                      var n = o()(i),
                        s = n.find(".js-scroll-el");
                      (e.animSpeed = n.is("[data-anim-speed]")
                        ? parseInt(n.attr("data-anim-speed"))
                        : 110),
                        r.ZP.set(s, { clearProps: !0 }),
                        e.createTl(s, n);
                    }),
                      y(t) &&
              ...
              },
              {
                ...
                value: function () {
                  ...
                  var e = new IntersectionObserver(function (e) {
                    ...
                    if (
                      e[0].intersectionRatio > P.threshold &&
                      !i.hasClass("start-horizontal-scroll")
                    ) {
                      ...
                      i.find(n).each(function (e, i) {
                        ...
                        (t.animSpeed = n.is("[data-anim-speed]")
                          ? parseInt(n.attr("data-anim-speed"))
                          : 110),
                          t.duplicateHTML(r),
                          t.loadImages(r, n);
              ...
              },
              {
                ...
                value: function (t, e) {
                  ...
                  r > 0
                    ? (n.on("load", function () {
                        r === (s += 1) &&
                          (i.createTl(t, e), i.resize(e.parents("section")));
                      }),
                      n.each(function (t, e) {
                ...
                value: function () {
                  ...
                  this.observer = new IntersectionObserver(function (e) {
                    t.observerTls.forEach(function (t) {
                      o()(e[0].target).is(o()(t.observeTarget)) &&
                ...
                value: function () {
                  ...
                  o()(window).on("scrollingAnimHandler", function (e, i) {
                    t.eventTls.forEach(function (t) {
                      i.element.is(t.section) &&
                        ("play" === i.state ? t.tl.play() : t.tl.pause());
                    });
                  });
                },
              },
            ...
            w(t, [
              {
                ...
                value: function () {
                  (this.isMobile = (0, s.tq)()),
                    (this.totalHeight =
                      o()(".smooth-scroll-wrapper").outerHeight() -
                      innerHeight),
                    ...
                    (this.pause1 =
                      ((0, s.wn)(this.section1.prevAll("section")) -
                        innerHeight +
                        (this.section1
                          .find(".scroll-wrap[data-scroll]")
                          .outerHeight() -
                          innerHeight) /
                          2 -
                        this.section1
                          .find(".section-phone-final-container")
                          .outerHeight() +
                        this.section1
                          .find(".section-dark-content-container")
                          .outerHeight() +
                        this.section1
                          .find(".section-intro-title-container")
                          .outerHeight()) /
                      this.totalHeight),
                    (this.duration1 =
                      this.section1
                        .find(".section-phone-final-container")
                        .outerHeight() / this.totalHeight),
                    (this.section2 = o()(".marketing-seo-section"));
                  var t = this.section2.find(".desktop-spacer-el").height();
                  (this.sectionTitleWrap = this.section2.find(
                    ".section-title-content-wrap"
                  )),
                    (this.blocksInnerWrap =
                      this.section2.find(".blocks-inner-wrap")),
                    (this.stickyBlockHalfOffset =
                      t - this.blocksInnerWrap.height()),
                    (this.txtItems = this.section2.find(
                      ".txt-items-wrap .txt-item"
                    )),
                    (this.pause2 =
                      ...
                      this.totalHeight),
                    (this.duration2 =
                      this.blocksInnerWrap.height() / this.totalHeight),
                    (this.duration3 =
                      (0.5 * o()(".services-section").outerHeight()) /
                      this.totalHeight),
                    (this.splitDur3 =
                      (innerHeight + this.stickyBlockHalfOffset) /
                      this.totalHeight /
                      (this.txtItems.length - 1)),
                    (this.section4 = o()(
                      ".key-performance-indicators-section"
                    )),
                    (this.pause4 =
                      ((0, s.wn)(this.section4.prevAll("section")) -
                        innerHeight) /
                      this.totalHeight),
                    (this.duration4 =
                      this.section4.find(".outer-content-wrap").outerHeight() /
                      this.totalHeight),
                    (this.section5 = o()(".clients-love-work-section")),
                    (this.section5Bgc = this.section5.find(".color-wrapper")),
                    (this.pause5 =
                      (0, s.wn)(this.section5.prevAll("section")) /
                      this.totalHeight),
                    (this.duration5 = (0.1 * innerHeight) / this.totalHeight),
                    (this.blocks5 = this.section5.find(".single-block")),
                    (this.blocks5Duration =
                      (this.section5.outerHeight() - innerHeight) /
                      this.totalHeight),
                    (this.section6 = o()(".cpg-logos-section")),
                    (this.pause6 =
                      ((0, s.wn)(this.section6.prevAll("section")) -
                        innerHeight) /
                      this.totalHeight),
                    (this.duration6 = (0.5 * innerHeight) / this.totalHeight),
                    (this.section7 = o()(".cpg-contact-section")),
                    (this.pause7 =
                      ((0, s.wn)(this.section7.prevAll("section")) -
                        innerHeight) /
                      this.totalHeight),
                    ...
                    (this.pause8 =
                      ...
                      this.totalHeight),
                    (this.duration8 =
                      (this.section7.outerHeight() - innerHeight) /
                      this.totalHeight),
                    (this.elPositionOffset = 0),
                ...
                value: function () {
                  ...
                  (this.tl = r.ZP.timeline({
                    ...
                    this.tl.fromTo(
                      ...
                      { backgroundColor: "#F3F3F3", duration: this.duration1 },
                      this.pause1
                    ),
                    this.tl.fromTo(
                      this.body,
                    ...
                    this.txtItems.each(function (t, i) {
                      if (0 !== t) {
                        ...
                        e.tl.fromTo(
                          e.body,
                          { backgroundColor: n.prev().data("block-color") },
                          {
                            backgroundColor: n.data("block-color"),
                            duration: e.splitDur3,
                          },
                          s
                        ),
                      ...
                      0 === t ||
                        (1 === t
                          ? (e.tl.fromTo(
                              ...
                              { backgroundColor: "#F4F4F4" },
                              {
                                backgroundColor: n.attr("data-body-color"),
                                duration:
                                  e.blocks5Duration / (e.blocks5.length - 1),
                              },
                              e.pause5
                            ),
                            e.tl.fromTo(
                    ...
                    this.tl.fromTo(
                      [this.body, this.section5Bgc],
                      { backgroundColor: "#D8F9DC" },
                      { backgroundColor: "#FFF", duration: this.duration6 },
                      this.pause6
                    ),
                    this.tl.fromTo(
                      [this.body, this.section5Bgc],
                      { backgroundColor: "#FFF" },
                      { backgroundColor: "#397252", duration: this.duration7 },
                      this.pause7
                    ),
                    this.tl.to(
                      {},
                    ...
                    this.tl.fromTo(
                      [this.body, this.section5Bgc],
                      { backgroundColor: "#397252" },
                      { backgroundColor: "#1E1E1E", duration: this.duration8 },
                      this.pause8
                    ),
                    this.tl.fromTo({}, {}, { duration: 1 }, 0),
                    (this.progressTo = r.ZP.quickTo(this.tl, "progress", {
                    ...
                    r.ZP.set(this.section5Bgc, {
                      backgroundColor: this.blocks5
                        .first()
                        .attr("data-body-color"),
                    });
                },
        ...
        B = (function () {
          function t() {
            f(this, t),
              this.brandsListSection(),
              this.marketingSeoSection(),
              this.clientsLoveSectionMobile();
          }
          return (
            w(t, [
              {
                ...
                value: function () {
                  o()(".brands-list-section")
                    .find(".brands-small-component video")
                    .attr("autoplay", !0);
                },
              },
              {
                ...
                value: function () {
                  o()(".marketing-seo-section")
                    ...
                    .each(function (t, e) {
                      var i = o()(e);
                      r.ZP.set(i, {
                        backgroundColor: i.attr("data-block-color"),
                      });
                    });
                },
              },
              {
                ...
                value: function () {
                  r.ZP.to(".clients-love-work-section .heart-svg", {
                    scale: 0.5714,
                    ease: "elastic.out(.8, 0.3)",
                    duration: 1,
                    yoyo: !0,
        ...
        Z = function () {
          var t = o()("#header"),
            ...
            i = t.find(".header-btn"),
            n = function () {
              r.ZP.set(".sticky-header-logo-link", {
                left: e.offset().left,
                top: e.position().top,
              }),
                r.ZP.set(".sticky-header-btn", {
                  left: i.offset().left,
                  top: i.position().top,
                });
            };
          n(),
            o()(window).on("resizeObserverTrigger", n),
            (0, s.tq)() &&
              o()(".sticky-header-logo-link, .sticky-header-btn").addClass(
                "show-link"
              );
        },
        D = function () {
                ...
                (n.prototype._parseNumber = function () {
                  ...
                  if (
                    ...
                    if (this._currentIndex != a)
                      for (var h = this._currentIndex - 1, c = 1; h >= a; )
                        (e += c * (this._string.charAt(h--) - "0")), (c *= 10);
                    if (
                      this._currentIndex < this._endIndex &&
                      "." == this._string.charAt(this._currentIndex)
                    ) {
